    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
      ...
      <main>
        <div class="container">
          ...
          <div class="col-md-6 mb-4 col-12">
            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <p class="card-text"><?= $figurine['license'] ?></p> <!--Récupération du nom du personnage-->
          ...
          <p><b>Attention ! Toutes les images des figurines proviennent du site https://manganim.fr/</b></p>
        </div>
      </main>
